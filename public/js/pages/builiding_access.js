...
async function generate_building_qr_code(template_id, fields_and_values_required, building_number) {
	...
	arr.push(`<p><img src='https://chart.googleapis.com/chart?cht=qr&chl=/${ngrok_url}/createVerificationQRCodeLookup/insert_wallet_holder_auth_token/${template_id}/${fields_and_values_required}&chs=200x200&chld=L|1' alt='qr code' /><p>`)
